package net.app315.hydra.example.server.util.codegenerate;
...
public class GeneratorServiceEntityUtil {
    ...
    private static final String DB_URL = "jdbc:mysql://192.168.2.214:3306/hydra_human_construction?characterEncoding=utf-8&useSSL=false";
    ...
    private static final String PACKAGE_NAME = "net.app315.hydra.human.construction.server";
    ...
    public static void main(String[] args) {
        ...
        System.out.println("当前模块根路径为:" + new File("hydra-example").getAbsolutePath());
        // 输入需要执行代码生成的数据库表名，支持多表，以逗号隔开
        generateByTables("hydra-example-server",
                "t_human_construction_member", "t_organization_member",
                "t_policy_release", "t_question", "t_question_type", "t_requirement", "t_supply", "t_telephone");
