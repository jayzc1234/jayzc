package net.app315.hydra.example.server.config.redis;
...
//        jedisPoolConfig.setTestWhileIdle(true);
	...
	@Bean
    @Primary
    public RedisLockUtil getRedisLockUtil(@Qualifier("humStringRedisTemplate") StringRedisTemplate stringRedisTemplate){
